...
<?php
    if($_POST){
        ...
        $sql=mysql_query("select * from userprofile where firstname like '%$query%' or user_lastname like '%$query%' order by user_id");
...
<?php
    if($_POST){
        $query=$_POST['search-form'];
        $sql=mysql_query("select * from userprofile where firstname like '%$query%' or lastname like '%$query%' order by user_id");
